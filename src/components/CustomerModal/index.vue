  ...
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-container">
      ...
      <div class="modal-body">
        <TabBasic v-show="activeTab === 'basic'" v-model="form" />
        <TabProject v-show="activeTab === 'project'" v-model="form" />
        <TabSales v-show="activeTab === 'sales'" v-model="form" />
        <TabTodo v-show="activeTab === 'todo'" v-model="form" />
        <TabSchedule v-show="activeTab === 'schedule'" v-model="form" />
      </div>
...
const props = defineProps<{ record: SalesRecord | null }>()
