    ...
    <div class="form-section">
      ...
      <div class="form-grid">
        <div class="form-group">
          <label>No</label>
          <input v-model.number="form.no" type="number" />
        </div>
        <div class="form-group">
          <label>新規ソート</label>
        ...
        <div class="form-group">
          <label>売上高（百万円）</label>
          <input v-model="form.revenue" type="number" step="0.1" />
        </div>
        <div class="form-group">
          <label>IT投資額（百万円）</label>
          <input v-model="form.itInvestment" type="number" step="0.1" />
        </div>
        <div class="form-group">
          <label>ITパートナー比率（%）</label>
          <input v-model="form.itPartnerRatio" type="number" step="0.1" />
        </div>
        <div class="form-group">
          <label>ITパートナー内SAS比率（%）</label>
          <input v-model="form.sasRatio" type="number" step="0.1" />
        </div>
        <div class="form-group">
          <label>部署名</label>
    ...
    <div class="form-section">
      ...
      <div class="form-grid">
        <div class="form-group span-2">
          ...
          <input v-model="form.businessDirector" type="text" placeholder="例：★山下 元（事業部長）[石井健]" />
        </div>
        <div class="form-group">
          <label>業務責任者（★決済者）</label>
          <input v-model="form.operationDirector" type="text" placeholder="例：★神谷 智仁[大内]" />
        </div>
        <div class="form-group">
          <label>現場責任者（☆ＰＭ）</label>
          <input v-model="form.siteDirector" type="text" placeholder="例：☆横江 聡明[小山]" />
        </div>
      </div>
    </div>
  </div>
